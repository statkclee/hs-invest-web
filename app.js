...
{ id: "cluster", n: "①b", t: "업종 집적", q: "행정동 입지계수 · 동종 근접도", render() {
  ...
  `<div class="tools"><b>그룹</b> <select id="cl-grp">${gOpts}</select> <b>세부 업종</b> <select id="cl-mid"></select> <span class="k">행정동 색 = LQ · 점 = 법인 사업장 · <span style="color:#9F1239">붉은 점</span> = DART 매핑 법인(이름·구간값 표시)</span></div>
  <div class="grid"><div class="card" style="grid-column:1/-1"><div id="p_cl_map" class="plot" style="height:560px"></div></div></div>
  <div class="grid"><div class="card"><h3 id="cl-ttl">행정동별 — 기업 · 종업원 · LQ</h3><div id="cl-tbl"></div></div></div>
